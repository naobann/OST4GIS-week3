...
var justOne = function(a) {return 1};
...
var justFalse = function(a) {isEven(justOne(a))};
...
var isOdd = function(a) {if(not(isEven(a))!==true){return false} else {return true}};
...
var filterOutLessThan10 = function(a){var b = [];for(i=0;i<a.length;i++){if(a[i]>10){b.push(a[i])}}return b}
...
var filter = function(array, func) { var b=[]; for (i=0;i<array.length;i++){if (func(array[i]) === true){b.push(array[i])}}return b};
